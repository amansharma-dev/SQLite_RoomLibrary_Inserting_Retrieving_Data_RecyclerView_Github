package com.example.sqlite_roomlibrary_inserting_retrieving_data_recyclerview_github.utils;

import android.content.Context;
import android.os.Environment;
import android.util.Log;

import com.example.sqlite_roomlibrary_inserting_retrieving_data_recyclerview_github.R;
...
//    }
    ...
    public static List<DataItem> importFromResource(Context context) {
        ...
        try {
            inputStream = context.getResources().openRawResource(R.raw.mymenuitems);
